...
export async function startBackgroundService(
  ...
  collectors = [
    windowTracker, screenshotService, clipboardMonitor, systemEvents,
    filesystemWatcher, gitTracker, keyboardTracker, mouseTracker,
    flowStateTracker, thrashingDetector, wikiGenerator, sessionBuilder,
    visionAnalyzer,
  ];
  ...
  log.info('RewindX background service running with all features');
}
